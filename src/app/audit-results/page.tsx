...
export default function AuditResults() {
  ...
  const criticalIssues = [
    { name: "Missing Meta Descriptions", category: "SEO", icon: Tag, count: 12, impact: "High" },
    { name: "Slow Page Load Speed", category: "Performance", icon: Zap, count: 8, impact: "High" },
    { name: "Broken Links", category: "Technical", icon: LinkIcon, count: 15, impact: "Medium" },
    { name: "Missing Alt Tags", category: "Accessibility", icon: ImageIcon, count: 23, impact: "Medium" },
    { name: "Duplicate Content", category: "Content", icon: FileText, count: 4, impact: "Low" },
  ]
  ...
  const recommendations = [
    {
      ...
      description: "Add unique meta descriptions to 8 pages that are missing them",
      impact: "High",
      category: "SEO",
      effort: "Medium",
      priority: "High",
    ...
    },
    {
      ...
      description: "Compress and resize images to reduce page load time (potential savings: 800KB)",
      impact: "High",
    ...
    },
    {
      ...
      description: "Add Content-Security-Policy and improve other security headers",
      impact: "Medium",
      category: "Security",
      effort: "High",
      priority: "Medium",
  ...
  return (
    <>
      {/* Header */}
      <AuditHeader showSidebar={showSidebar} setShowSidebar={setShowSidebar} auditDetails={auditDetails} />
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge className="ml-2">{new Date(auditDetails.date).toLocaleDateString()}</Badge>
              </div>
              <div className="flex items-center gap-4 mt-2 text-sm text-gray">
                <div className="flex items-center gap-1">
                  <Clock size={14} />
                  <span>Duration: {auditDetails.duration}</span>
                </div>
                <div className="flex items-center gap-1">
                  <FileText size={14} />
                  ...
                  <AccordionItem value="meta-tags">
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex items-center gap-2">
                        <Tag size={16} />
                        <span>Meta Tags</span>
                        <Badge className="ml-2 bg-warning/20 text-warning border-warning/20">Needs Improvement</Badge>
                      </div>
                    </AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-4 pt-2">
                        <div>
                          ...
                          <Progress value={85} className="h-2" indicatorClassName="bg-success" />
                          <p className="text-xs text-gray mt-1">12 pages with optimized titles, 3 need improvement</p>
                        </div>
                        ...
                        <div>
                          ...
                          <Progress value={65} className="h-2" indicatorClassName="bg-warning" />
                        ...
                        <div className="bg-muted/50 p-4 rounded-lg">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-start gap-2">
                              ...
                              <span>Add unique meta descriptions to all pages (8 missing)</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-primary mt-1">•</span>
                              <span>Optimize meta descriptions to be between 120-158 characters</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-primary mt-1">•</span>
                              <span>Include primary keywords in meta descriptions</span>
                            </li>
                          </ul>
                        </div>
                        ...
                        {auditDetails.isGuest && (
                          <div className="mt-2 p-3 bg-primary/5 rounded-lg border border-primary/10 text-center">
                            <p className="text-sm text-gray mb-2">
                              Sign up to see affected pages and detailed recommendations
                            </p>
